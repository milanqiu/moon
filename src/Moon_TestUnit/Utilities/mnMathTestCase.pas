...
procedure TmnMathTestCase.testRound;
begin
  CheckEquals(mnRound(4041.5), 4042);
  CheckEquals(mnRound(4042.5), 4043);
  CheckEquals(mnRound(4043.5), 4044);
  CheckEquals(mnRound(4041.4999), 4041);
  CheckEquals(mnRound(4042.4999), 4042);
  CheckEquals(mnRound(4043.4999), 4043);
  CheckEquals(mnRound(4041.5001), 4042);
  CheckEquals(mnRound(4042.5001), 4043);
  CheckEquals(mnRound(4043.5001), 4044);

  CheckEquals(mnRound(40.415, -2), 40.42, mnParticle);
  CheckEquals(mnRound(40.425, -2), 40.43, mnParticle);
  CheckEquals(mnRound(40.435, -2), 40.44, mnParticle);
  CheckEquals(mnRound(40.414999, -2), 40.41, mnParticle);
  CheckEquals(mnRound(40.424999, -2), 40.42, mnParticle);
  CheckEquals(mnRound(40.434999, -2), 40.43, mnParticle);
  CheckEquals(mnRound(40.415001, -2), 40.42, mnParticle);
  CheckEquals(mnRound(40.425001, -2), 40.43, mnParticle);
  CheckEquals(mnRound(40.435001, -2), 40.44, mnParticle);

  CheckEquals(mnRound(40415, 1), 40420);
  CheckEquals(mnRound(40425, 1), 40430);
  CheckEquals(mnRound(40435, 1), 40440);
  CheckEquals(mnRound(40414.999, 1), 40410);
  CheckEquals(mnRound(40424.999, 1), 40420);
  CheckEquals(mnRound(40434.999, 1), 40430);
  CheckEquals(mnRound(40415.001, 1), 40420);
  CheckEquals(mnRound(40425.001, 1), 40430);
  CheckEquals(mnRound(40435.001, 1), 40440);
